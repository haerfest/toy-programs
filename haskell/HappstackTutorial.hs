...
queryParams = do mFoo <- optional $ lookText "foo"
...
upload = msum [ uploadForm, handleUpload ]
  where
    ...
    handleUpload = do (tmpFile, uploadName, contentType) <- lookFile "file_upload"
